...
function Coefficient(state){
  this.set = function(coefficient){
    state.coefficient = coefficient;
    state.alpha       = Terme.converter.toAlpha[coefficient];
  }
...
function Terme(constant, degree, isAlpha = true){
  let state = {
    coefficient:0,
    alpha      :0,
    degree     :degree,
  ...
  Object.defineProperty(this, "alpha"      , new Alpha      (state));
  Object.defineProperty(this, "coefficient", new Coefficient(state));
  Object.defineProperty(this, "degree"     , new Degree     (state));
  ...
  this.multiply = function multiply(terme){
    return new Terme((this.alpha + terme.alpha) % 255, this.degree + terme.degree);
  }

  this.xor      = function xor     (terme){
    return new Terme(this.coefficient ^ terme.coefficient, this.degree, false);
  }
}
